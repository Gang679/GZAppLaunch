...
- (void)viewDidLoad{
    ...
    [self touchesBegan:[NSSet alloc] withEvent:[UIEvent alloc]];
}
...
- (void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event
{
    ...
    [YQAnimationLayer createAnimationLayerWithString:@"恭喜你，答对了" andRect: CGRectMake(0, 100, self.view.frame.size.width, self.view.frame.size.width) andView:self.view andFont:[UIFont boldSystemFontOfSize:40] andStrokeColor:[UIColor cyanColor]];
