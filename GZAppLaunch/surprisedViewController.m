...
@interface surprisedViewController ()<CAAnimationDelegate>

@property(nonatomic, strong)UILabel  *label;
@end

@implementation surprisedViewController
...
- (void)SetupLayer{
    UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(150, 200, 100, 100)];
    label.text = @"哈哈哈,你个笨蛋";
